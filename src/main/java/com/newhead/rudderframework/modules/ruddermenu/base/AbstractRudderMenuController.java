...
public abstract class AbstractRudderMenuController extends WebController  {
    ...
    public ApiEntity getPage(@RequestParam(required = false) String ruddermenuName,@RequestParam(required = false) Integer page,@RequestParam(required = false) Integer size) {
        ...
        Page<List<SimpleRudderMenuQueryResponse>> sources = getService().queryPage(request);
