...
public abstract class AbstractRudderRoleController extends WebController  {
    ...
    public ApiEntity getPage(@RequestParam(required = false) String rudderroleName,@RequestParam(required = false) Integer page,@RequestParam(required = false) Integer size) {
        ...
        Page<List<SimpleRudderRoleQueryResponse>> sources = getService().queryPage(request);
