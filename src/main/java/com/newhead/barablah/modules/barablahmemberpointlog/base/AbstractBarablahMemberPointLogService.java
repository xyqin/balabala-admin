 ...
 */
public abstract class AbstractBarablahMemberPointLogService extends BaseService {
    protected abstract BarablahMemberPointLogMapper getMapper();

    protected abstract void saveOrUpdate(BarablahMemberPointLog entity);
     ...
     */
    @Transactional
    public BarablahMemberPointLog create(SimpleBarablahMemberPointLogCreateRequest request) {
        BarablahMemberPointLog entity = new BarablahMemberPointLog();
     ...
     */
    @Transactional
    public BarablahMemberPointLog update(SimpleBarablahMemberPointLogUpdateRequest request) {
        BarablahMemberPointLog entity = new BarablahMemberPointLog();
        BeanUtils.copyProperties(request,entity);
        entity.setUpdatedAt(new Date());
        entity.setDeleted(false);
     ...
     * @return
     */
    public SimpleBarablahMemberPointLogGetDetailResponse getDetail(Long id) {
        BarablahMemberPointLog entity = getMapper().selectByPrimaryKey(id);
        if (entity.getDeleted()) {
            throw new ApiValidateException(ApiStatus.STATUS_400.getCode(),"资源名称已经被删除或者并不存在！");
        }
        SimpleBarablahMemberPointLogGetDetailResponse response = new SimpleBarablahMemberPointLogGetDetailResponse();
        ...
        typeEnum.setLabel(com.newhead.barablah.modules.barablahmemberpointlog.BarablahMemberPointLogTypeEnum.getLabel(entity.getType()));
     ...
     * @return list
     */
    public List<SimpleBarablahMemberPointLogQueryResponse> queryList(SimpleBarablahMemberPointLogQueryListRequest request) {
        List<SimpleBarablahMemberPointLogQueryResponse> results = new ArrayList<SimpleBarablahMemberPointLogQueryResponse>();
     ...
     * @return page
     */
    public Page<SimpleBarablahMemberPointLogQueryResponse> queryPage(SimpleBarablahMemberPointLogQueryPageRequest request) {
        //结果
        List<SimpleBarablahMemberPointLogQueryResponse> results = new ArrayList<SimpleBarablahMemberPointLogQueryResponse>();
    ...
    private void convertEntityToResponse(List<BarablahMemberPointLog> entitys,List<SimpleBarablahMemberPointLogQueryResponse> results) {
       ...
       for(BarablahMemberPointLog entity:entitys) {
        ...
        //第一组
        for(BarablahMemberPointLog entity:entitys) {
            SimpleBarablahMemberPointLogQueryResponse response = new SimpleBarablahMemberPointLogQueryResponse();
            BeanUtils.copyProperties(entity,response);
