 ...
 */
@Api(tags = "音频", description = "音频API")
@RestController
@RequestMapping("/audio")
public class AudioController extends FileController {

    private static final String[] SUPPORTED_IMAGE_EXTENSIONS = {"mp3"};
    ...
    public ApiEntity<String> uploadImage(@RequestParam("file") Part file) throws IOException {
        ...
        try {
            ...
            String localPath = config.storepath + "/audio/" + currentDate + "/";
        ...
        String link = config.storelink + "/audio/" + currentDate + "/" + filename;
