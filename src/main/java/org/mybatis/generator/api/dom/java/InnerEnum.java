...
/**
 * This class encapsulates the idea of an inner EnumBuilder - it has methods that make
 * it easy to generate inner EnumBuilder.
 * 
 * @author Jeff Butler
 */
public class InnerEnum extends JavaElement {
    ...
    /** The EnumBuilder constants. */
    private List<String> enumConstants;

    /**
     * Instantiates a new inner EnumBuilder.
     *
     * @param type
     *            the type
     */
    ...
    /**
     * Adds the inner EnumBuilder.
     *
     * @param innerEnum
     *            the inner EnumBuilder
     */
    ...
    /**
     * Gets the EnumBuilder constants.
     *
     * @return the EnumBuilder constants
     */
    ...
    /**
     * Adds the EnumBuilder constant.
     *
     * @param enumConstant
     *            the EnumBuilder constant
     */
    ...
    public String getFormattedContent(int indentLevel, CompilationUnit compilationUnit) {
        ...
        sb.append("EnumBuilder "); //$NON-NLS-1$
