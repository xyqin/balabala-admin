...
/**
 * 生成时间：2018年03月13日 07:57:12
 * 该文件系自动生成，手动修改可能会被替换
 * BarablahMemberUpdateReq
 * 接口地址：barablahmember/update
 * 请求方式：Post
 * 接口说明：编辑
 */
class BarablahMemberUpdateReq extends BaseRobotReq {
    constructor(options, params, successFn, errorFn) {
        super(options, params, successFn, errorFn);
        // 配置当前接口请求的，包含url、请求类型、请求内容类型等
        // 约定url使用相对地址，都以斜杠开头
        this._defaultOptions = {
            url: '/barablahmember/update',
            type: 'Post',
     ...
     * @param id 活动编号
     */
    setSimpleParams(id,campusId,nickname,avatar,englishName,gender,birthday,status,points) {
...
export default BarablahMemberUpdateReq;
