 ...
 * 该文件系自动生成，手动修改可能会被替换
 * BalabalaClassGetpageReq
 * 接口地址：balabalaclass/getpage
 * 请求方式：Get
 * 接口说明：查找
 */
class BalabalaClassGetpageReq extends BaseRobotReq {
    constructor(options, params, successFn, errorFn) {
        super(options, params, successFn, errorFn);
        // 配置当前接口请求的，包含url、请求类型、请求内容类型等
        // 约定url使用相对地址，都以斜杠开头
        this._defaultOptions = {
            url: '/balabalaclass/getpage',
            type: 'Get',        };
        // 请求参数的描述信息，只定义先不用
...
export default BalabalaClassGetpageReq;
